...
const HoverRevealCardV2 = ({
    ...
    const pseudoInit = [
        ...
        'before:w-0',
        'before:h-0',
        'before:transition-[width,height]',
        'before:duration-300',
        'before:ease-out',
    ...
    const pseudoHover = isHovered
        ? [
            // before hover
            'before:w-full',
            'before:h-full',
            'before:border-t-[#f25978]',
            'before:border-r-[#f25978]',
            // after hover
        ].join(' ')
        : '';
    ...
    return (
        <div
            ...
            className={`${baseClasses} ${pseudoInit} ${pseudoHover}`}
        >
            ...
            <div className="w-[120%] h-[200px] mt-5">
                <div
                    className={
                        `font-knewave text-[36px] text-[#f25978] mb-[50px] relative top-0 left-0 transition-all duration-1000
                        ${isHovered ? 'left-[45%]' : 'left-[0]'}
                    `}
                >
                    {title}
                ...
                <p
                    className={
                    `relative w-[160px] font-raleway text-sm text-[#404040] left-0 bottom-8 leading-[1.8] transition-all duration-1000
                    ${isHovered ? 'left-[45%]' : 'left-[0]'}`
                }
                >
                    {description}
...
export default HoverRevealCardV2;